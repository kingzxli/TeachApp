...
//    客户填写“帮我选师”后，管理者能够收到通知提醒
    public static JSONObject sendMpMessage(String openid,String name,String phone,String address,String addtime,String trial){
...
//    支付成功，管理员收到消息
    public static JSONObject sendPay(String openid,String money,String message,String ordernum){
    	JSONObject result = new JSONObject();
		JSONObject obj = new JSONObject();
		JSONObject mp_template_msg = new JSONObject();
		JSONObject miniprogram = new JSONObject();
    ...
    //打卡通知
    public static JSONObject sendPunch(String openid,String project,String addtime,String tname){
    	JSONObject result = new JSONObject();
		JSONObject obj = new JSONObject();
		JSONObject mp_template_msg = new JSONObject();
		JSONObject miniprogram = new JSONObject();
    ...
    //老师应聘生源单，家长收到通知
    public static JSONObject yingpin(String frist,String openid,String project,String addtime,String address,String status){
    	JSONObject result = new JSONObject();
		JSONObject obj = new JSONObject();
		JSONObject mp_template_msg = new JSONObject();
		JSONObject miniprogram = new JSONObject();
    ...
    //家长指定时间下单，老师收到信息
    public static JSONObject paypush(String frist,String openid,String project,String addtime,String address,String status){
    	JSONObject result = new JSONObject();
		JSONObject obj = new JSONObject();
		JSONObject mp_template_msg = new JSONObject();
		JSONObject miniprogram = new JSONObject();
    ...
    public static JSONObject parentPass(String frist,String openid,String project,String addtime,String address,String status){
    	JSONObject result = new JSONObject();
		JSONObject obj = new JSONObject();
		JSONObject mp_template_msg = new JSONObject();
		JSONObject miniprogram = new JSONObject();
    ...
    //老师审核反馈
    public static JSONObject audit(String frist,String openid,String name,String addtime,String other,String remark){
    	JSONObject result = new JSONObject();
		JSONObject obj = new JSONObject();
		JSONObject mp_template_msg = new JSONObject();
		JSONObject miniprogram = new JSONObject();
		...
		try {
	    	...
	    	json2 = new JSONObject();
	    	json2.put("value", other);
	    	json1.put("keyword3", json2);
	    	
	    	json2 = new JSONObject();
	    	json2.put("value", remark);
	    	json1.put("remark", json2);
	    	
			String path = "https://api.weixin.qq.com/cgi-bin/message/wxopen/template/uniform_send?access_token="+accessToken;
			obj.put("touser", openid);
			mp_template_msg.put("appid","wx2da6d0a84363b015");
			mp_template_msg.put("template_id", "UnXqUijRDwn_p1yPdkAnvwcSpMTX6DXUjP4cq3QuB6w");
			mp_template_msg.put("url","https://www.baidu.com");
			miniprogram.put("appid", "wxf020b9146ae3ec37");
			miniprogram.put("pagepath", "");
			mp_template_msg.put("miniprogram", miniprogram);
